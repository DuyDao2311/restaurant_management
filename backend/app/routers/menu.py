...
def get_menu_items(
    ...
    """Get all menu items. Requires: any authenticated user (ADMIN, STAFF, CUSTOMER)."""
    try:
...
def delete_menu_item(
    ...
    if order_item_count > 0:
        return JSONResponse(
            ...
            content={
                "success": False,
                "message": f"Cannot delete this menu item because it is being used in {order_item_count} order(s)"
            }
        )
