      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <nav className="hidden lg:flex items-center space-x-10">
            <Link 
              to="/" 
              className="text-xs font-bold uppercase tracking-wider text-gray-900 border-b-2 py-1" 
              style={{ borderColor: goldColor }}
            >
              Trang chủ
            </Link>
            <Link to="/menu" className="text-xs font-bold uppercase tracking-wider text-gray-500 hover:text-gray-900 py-1 transition-colors">
              Thực đơn
            </Link>
            <Link to="/wine" className="text-xs font-bold uppercase tracking-wider text-gray-500 hover:text-gray-900 py-1 transition-colors">
              Hầm rượu
            </Link>
            <Link to="/vip" className="text-xs font-bold uppercase tracking-wider text-gray-500 hover:text-gray-900 py-1 transition-colors">
              Phòng VIP
            </Link>
