...
const Home = () => {
  ...
  const [guests, setGuests] = useState('2 Khách (Bàn đôi)');
  const [notes, setNotes] = useState('');
  
  const handleBooking = (e: FormEvent) => {
    e.preventDefault();
    alert('Yêu cầu đặt bàn của bạn đã được gửi!');
  };
          ...
          <div className="bg-[#FAF9F5] p-10 sm:p-16 shadow-sm border border-gray-100">
            ...
            <form onSubmit={handleBooking} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="2 Khách (Bàn đôi)">2 Khách (Bàn đôi)</option>
                    <option value="3-4">3 - 4 Khách</option>
                    <option value="5-8">5 - 8 Khách</option>
                    <option value="9+">Từ 9 Khách trở lên</option>
                  </select>
                </div>
              </div>
              ...
              <div className="pt-4 text-center">
                <button 
                  type="submit" 
                  className="bg-[#111] text-white px-10 py-4 text-xs font-bold uppercase tracking-widest hover:bg-gray-800 transition-colors inline-block"
                >
                  Xác nhận đặt bàn
                </button>
              </div>
