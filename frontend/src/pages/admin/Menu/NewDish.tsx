    ...
    <div className="p-8 max-w-7xl mx-auto h-full flex flex-col overflow-y-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-serif text-gray-900 mb-2">Thêm Món Mới Vào Thực Đơn</h1>
            <p className="text-gray-500 text-sm">
              Nhập thông tin tiêu chuẩn ẩm thực, phân loại nguyên liệu thượng hạng và thiết lập cơ chế định giá.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Form Content */}
      <form id="new-dish-form" onSubmit={handleSubmit} className="flex-1 flex flex-col md:flex-row gap-8">
